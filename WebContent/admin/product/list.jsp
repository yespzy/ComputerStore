...
<HTML>
	...
	<body>
		<br>
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/adminProduct?method=findproduct" method="post">
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="pid" size="15" value="" id="Form1_userName" class="bg" />
								</td>
							</tr>
							<tr>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">商品名称：</td>
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="pname" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								...
								<c:forEach items="${list }" var="p" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'"
											...
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProduct?method=editfindProductById&pid=${p.pid}&type=admin">
													<img src="${pageContext.request.contextPath}/images/admin/order_edit.gif" border="0" style="CURSOR: hand">
												</a>
											</td>
									
											<td align="center" style="HEIGHT: 22px">
												<a href="${ pageContext.request.contextPath }/adminProduct?method=deleteProductById&pid=${p.pid}" onclick="javascript:return p_del()">
