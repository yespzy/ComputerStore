...
<HTML>
	...
	<body>
		<br>
		<form id="Form" name="Form" action="${pageContext.request.contextPath}/adminOrder?method=findorder" method="post">
						...
						<table cellpadding="0" cellspacing="0" border="0" width="100%">
							<tr>
								...
								<td class="ta_01" bgColor="#ffffff">
									<input type="text" name="oid" size="15" value="" id="Form1_userName" class="bg" />
								</td>
								<td height="22" align="center" bgColor="#f5fafe" class="ta_01">
									收货人：</td>
								<td class="ta_01" bgColor="#ffffff">
					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
								...
								<tr
									style="FONT-WEIGHT: bold; FONT-SIZE: 12px; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
									...
									<c:forEach items="${list}" var="o" varStatus="vs">
										<tr onmouseover="this.style.backgroundColor = 'white'";
											...
											<td align="center" style="HEIGHT: 22px">
										       <a href="${pageContext.request.contextPath}/adminOrder?method=findorderDetailsById&oid=${o.oid}">
											      <img src="${pageContext.request.contextPath}/images/admin/order_view.gif" border="0" style="CURSOR: hand">
										       </a>
									       </td>
									       <td align="center" style="height: 22px;">
                                                 <!--  已完成，弹出提示框由操作人确认 -->
									             <c:if test="${o.state==3 }">
											         <a href="${pageContext.request.contextPath}/adminOrder?method=deleteOrderById&oid=${o.oid}&state=${o.state}" onclick="javascript:return o_del()">
												        <img src="${pageContext.request.contextPath}/images/admin/order_delete.gif" width="16" height="16" border="0" style="CURSOR: hand">
											        </a>
										        </c:if> 
										        <!--  未完成 ，不能删除-->
										        <c:if test="${o.state!=3 }">
											         <a href="javascript:alert('不能删除未完成订单')">
												         <img src="${pageContext.request.contextPath}/images/admin/order_delete.gif" width="16" height="16" border="0" style="CURSOR: hand">
											         </a>
										       </c:if>
								       	  </td>
