					...
					<div class="col-md-8" style="background:#fff;padding:40px 80px;margin:30px;border: 1px solid #EEEDDB;">
						...
						<form class="form-horizontal" style="margin-top:5px;" method="post" action="${pageContext.request.contextPath }/user">
							<input type="hidden" name="method" value="editpassword">
							 ...
							 <div class="form-group">
							    <label for="username" class="col-sm-2 control-label">旧用户名</label>
							    <div class="col-sm-6">
							       <table>
						              <tr>
							            <td>
								           <input type="text" class="form-control" id="username" placeholder="请输入旧的用户名" name="username" onkeyup="checkUsername();">
							            </td>
							            <td>
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-6">
							       <table>
						              <tr>
							            <td>
								           <input type="password" class="form-control" id="password" placeholder="请输入新的密码" name="password" onkeyup="checkPassword()">
							            </td>
							            <td>
							   ...
							   <div class="form-group">
							    ...
							    <div class="col-sm-6">
							        <table>
						              <tr>
							            <td>
								          <input type="password" class="form-control" id="confirmpwd" placeholder="请再次确认密码" onkeyup="checkConfirm()">
							            </td>
							            <td>
							  ...
							  <div class="form-group">
							    <label for="email" class="col-sm-2 control-label">旧Email</label>
							    <div class="col-sm-6">
							       <table>
						              <tr>
							            <td>
								           <input type="email" class="form-control" id="email" placeholder="请输入旧的Email" name="email" onkeyup="checkEmail();">
							            </td>
							            <td>
