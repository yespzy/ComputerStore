...
<html>
	...
	<body>
			...
			<div class="row">
				<div style="margin:0 auto;width:950px;">
					...
					<div class="col-md-6">
						...
						<div style="margin:10px 0 10px 0;">商城价: <strong style="color:#ef0101;">￥：${bean.shop_price }元</strong>  &nbsp;&nbsp;市场价： <del>￥${bean.market_price }元</del></div>
						...
						<div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
							...
							<form action="${pageContext.request.contextPath }/cart" id="form" method="get">
								<!-- 提交的方法  -->
								...
								<a href="javascript:void(0)" onclick="subForm()">
									<input style="background: url('${pageContext.request.contextPath}/images/client/cart_submit.gif') no-repeat scroll 0 -600px rgba(0, 0, 0, 0);height:36px;width:127px;" value="加入购物车" type="button">
								</a> &nbsp;收藏商品
						 </div>
		...
		<div style="margin-top:50px;">
			<img src="${pageContext.request.contextPath}/images/client/footer.jpg" width="100%" height="78" alt="我们的优势" title="我们的优势" />
		</div>
